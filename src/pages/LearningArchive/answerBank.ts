...
export const learningInterviewBank: Record<string, InterviewPack> = {
  ...
  '2026-04-05': {
    summary:
      '这周不是在加新知识点，而是在把高频概念从“知道”推进到“能稳定讲出来”，重点是把 JS 高频题和 AI 关键概念串成完整表达。',
    answers: [
      {
        question: '这周 JS 部分最大的收获是什么？',
        answer:
          '这周我重点把 this、原型链、深浅拷贝这些高频题重新串了一遍，现在不只是知道定义，而是开始能按“概念是什么、为什么这样、和谁有什么区别”的方式稳定口述出来。',
      },
      {
        question: '这周 AI 部分最大的收获是什么？',
        answer:
          '这周我把 RAG、Embedding、向量数据库、Function Calling、多模态、上下文窗口串起来了，开始能从产品和技术两边理解这些概念，并说清它们分别解决什么问题、彼此之间怎么分工。',
      },
      {
        question: 'RAG 和 Function Calling 的区别是什么？',
        answer:
          'RAG 主要解决的是模型回答时缺少外部知识依据的问题，它会先检索资料再生成答案；Function Calling 主要解决的是模型没有行动能力的问题，它会让模型按结构化格式选择并请求调用外部工具，再由系统真正执行。简单说，RAG 偏补知识，Function Calling 偏调工具做事。',
      },
      {
        question: '多模态和上下文窗口分别影响什么？',
        answer:
          '多模态影响的是模型能接收和理解什么形式的信息，它让 AI 产品从纯文本输入扩展到图片、音频、视频等更真实的交互方式；上下文窗口影响的是模型一次能处理多少信息，它决定了系统在多轮对话、长文档处理和复杂任务里能承载多大信息量。',
      },
    ],
  },
  '2026-04-06': {
